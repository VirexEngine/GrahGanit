...
export const Route = createFileRoute('/services/marriage-matching')({
  ...
  head: () => ({
    meta: [
      { title: 'Kundali Matching & Compatibility | GrahGanit' },
    ],
  }),
})
  ...
  return (
    <div className="relative min-h-screen bg-cosmos text-foreground overflow-x-hidden">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 mx-auto max-w-7xl min-h-[70vh] flex flex-col items-center justify-center text-center">
        <h1 className="text-4xl md:text-6xl font-display text-gradient-gold mb-6">Kundali Milan & Compatibility</h1>
        <p className="text-lg text-foreground/70 max-w-2xl mb-8">Authentic 36 Guna Ashtakoot Milan, Mangal Dosha check, and emotional-spiritual harmony analysis on GrahGanit.</p>
      </main>
      <Footer />
      <FloatingActions />
    </div>
